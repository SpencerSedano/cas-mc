...
"")
        ...
        self.VisionReset = QPushButton(self.VisionPage)
        self.VisionReset.setObjectName(u"VisionReset")
        self.VisionReset.setGeometry(QRect(50, 500, 233, 79))
        sizePolicy.setHeightForWidth(self.VisionReset.sizePolicy().hasHeightForWidth())
        self.VisionReset.setSizePolicy(sizePolicy)
        self.VisionReset.setStyleSheet(u"")
        self.VisionReset.setCheckable(False)
...
"}")
        ...
        self.RunForkliftButton.setGeometry(QRect(30, 60, 121, 71))
        ...
        self.StopForkliftButton.setGeometry(QRect(170, 60, 121, 71))
        ...
        self.ListOptionsWidget.setGeometry(QRect(10, 100, 291, 451))
...
"Record", None))
        ...
        self.VisionReset.setText(QCoreApplication.translate("MainWindow", u"Reset", None))
